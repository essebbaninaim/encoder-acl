...
header=r"""\begin{table*}[]
    ...
    \begin{tabular}{lcccccc}
        \toprule
        & \textbf{BLESS} & \textbf{CogALexV} & \textbf{EVALution} & \textbf{K\&H+N} & \textbf{ROOT09} & \textbf{Average} \\

"""

footer=r"""    \bottomrule
\end{tabular}}
\caption{[MODEL_NAME] performance on lexical relation classification with [BASED_ENCODER]}
\end{table*}
"""

raw_start = r"""        \midrule
    \multicolumn{7}{c}{\textit{[DATASET_NAME]}} \\"""
